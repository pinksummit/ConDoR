 ...
 */
public class IngestRequestAudit extends AbstractAuditor{

    private static final String AUDIT_TEMPLATE = "CondorAuditIngest-Request.xml";
    ...
    public IngestRequestAudit(){
        super(IngestRequestAudit.class.getName());
    }
    ...
    public String getAuditLogType(){
        return AbstractAuditor.AUDIT_CLIENT_INGEST_REQUEST;
    }
